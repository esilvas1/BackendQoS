...
SET  TT2_PROPIEDAD       = (SELECT DISTINCT (TT2_PROPIEDAD       ) FROM QA_TTT2_TEMP WHERE TT2_ESTADO = 'OPERACION' AND TT2_CODIGOELEMENTO = RT.TT2_CODIGOELEMENTO)
	,TT2_LONGITUD        = (SELECT DISTINCT (TT2_LONGITUD        ) FROM QA_TTT2_TEMP WHERE TT2_ESTADO = 'OPERACION' AND TT2_CODIGOELEMENTO = RT.TT2_CODIGOELEMENTO)
	,TT2_LATITUD         = (SELECT DISTINCT (TT2_LATITUD         ) FROM QA_TTT2_TEMP WHERE TT2_ESTADO = 'OPERACION' AND TT2_CODIGOELEMENTO = RT.TT2_CODIGOELEMENTO)
	,TT2_ALTITUD         = (SELECT DISTINCT (TT2_ALTITUD         ) FROM QA_TTT2_TEMP WHERE TT2_ESTADO = 'OPERACION' AND TT2_CODIGOELEMENTO = RT.TT2_CODIGOELEMENTO)
	,TT2_NOMBRE_CIRCUITO = (SELECT DISTINCT (TT2_NOMBRE_CIRCUITO ) FROM QA_TTT2_TEMP WHERE TT2_ESTADO = 'OPERACION' AND TT2_CODIGOELEMENTO = RT.TT2_CODIGOELEMENTO)
	,TT2_IUL             = (SELECT DISTINCT (TT2_IUL             ) FROM QA_TTT2_TEMP WHERE TT2_ESTADO = 'OPERACION' AND TT2_CODIGOELEMENTO = RT.TT2_CODIGOELEMENTO)
WHERE TT2_CODIGOELEMENTO IN(
...
AND TT2_CODIGOELEMENTO NOT IN (
							  ...
							  FROM QA_TTT2_TEMP 
							  WHERE TT2_PROPIEDAD       IS NOT NULL 
							  AND   TT2_LONGITUD        IS NOT NULL 
							  AND   TT2_LATITUD         IS NOT NULL
							  AND   TT2_ALTITUD         IS NOT NULL 
							  AND   TT2_NOMBRE_CIRCUITO IS NOT NULL
							  AND   TT2_IUL             IS NOT NULL
							  )						   
;
