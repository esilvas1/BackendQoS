...
SELECT CS1_PERIODO_OP ,CS1_SAIDI_M  FROM QA_TCS1 
WHERE TO_CHAR(CS1_PERIODO_OP,'YYYY') = '2022'
ORDER BY 1;


SELECT COUNT(1) FROM QA_TTC1 WHERE TC1_PERIODO = 202201;
