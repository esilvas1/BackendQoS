...
SELECT DISTINCT TC1_CODCONEX FROM BRAE.QA_TTC1 WHERE TC1_PERIODO=202305
MINUS
...
FROM (
        ...
        MINUS
        SELECT DISTINCT TC1_CODCONEX,TC1_IUA FROM QA_TTC1 WHERE TC1_PERIODO=202305
     )
MINUS
(SELECT DISTINCT TC1_CODCONEX FROM QA_TTC1_TEMP
MINUS
...
WHERE TC1_CODCONEX IN (
                        ...
                        FROM(
                        SELECT DISTINCT TC1_CODCONEX AS X,TC1_IUA
                        FROM QA_TTC1 WHERE TC1_PERIODO=202305) T
                        HAVING COUNT(T.X) > 1 
                        GROUP BY T.X
                      );
...
WHERE TC1_PERIODO=202305; --605.324  Filas

DELETE FROM QA_TTC1
WHERE TC1_PERIODO=202305; -- 605,324 rows affected in 1 m 12 s 220 ms
COMMIT;

--INSERTAR QA_TTC1_TEMP A QA_TTC1
INSERT INTO QA_TTC1
SELECT * FROM QA_TTC1_TEMP; --605.353 filas insertadas.

COMMIT;

--Verificacion de la cantidad insertada
SELECT COUNT(*) FROM QA_TTC1 WHERE TC1_PERIODO=202305; --605.353 filas insertadas
--OK
