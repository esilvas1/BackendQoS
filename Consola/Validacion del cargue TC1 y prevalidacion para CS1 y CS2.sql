...
SELECT DISTINCT TC1_CODCONEX FROM BRAE.QA_TTC1 WHERE TC1_PERIODO=202312
MINUS
...
FROM (
        ...
        MINUS
        SELECT DISTINCT TC1_CODCONEX,TC1_IUA FROM QA_TTC1 WHERE TC1_PERIODO=202312
     )
MINUS
(SELECT DISTINCT TC1_CODCONEX FROM QA_TTC1_TEMP
MINUS
...
WHERE TC1_CODCONEX IN (
                        ...
                        FROM(
                        SELECT DISTINCT TC1_CODCONEX AS X,TC1_IUA
                        FROM QA_TTC1 WHERE TC1_PERIODO=202312) T
                        HAVING COUNT(T.X) > 1 
                        GROUP BY T.X
                      );
...
WHERE TC1_PERIODO=202312; --617.059  Filas

DELETE FROM QA_TTC1
WHERE TC1_PERIODO = 202312; -- 617,059 rows affected 
COMMIT;

--INSERTAR QA_TTC1_TEMP A QA_TTC1
INSERT INTO QA_TTC1
SELECT * FROM QA_TTC1_TEMP; --617.075 filas insertadas.

COMMIT;

--Verificacion de la cantidad insertada
SELECT COUNT(*) FROM QA_TTC1 WHERE TC1_PERIODO=202312; --617.075 filas insertadas
--OK
