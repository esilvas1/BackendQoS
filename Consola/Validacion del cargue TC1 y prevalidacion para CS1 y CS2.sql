...
SELECT DISTINCT TC1_CODCONEX FROM BRAE.QA_TTC1 WHERE TC1_PERIODO=202308
MINUS
...
MINUS
SELECT DISTINCT TC1_CODCONEX FROM QA_TTC1 WHERE TC1_PERIODO=202308;
...
AND I.FINICIAL >= TO_DATE('01/05/2023','DD/MM/YYYY')
AND I.FINICIAL  <  TO_DATE('01/06/2023','DD/MM/YYYY')
AND I.TRAFO='1T10895';
...
AND I.TRAFO IN (SELECT DISTINCT TC1_CODCONEX FROM QA_TTC1_TEMP
              MINUS
               SELECT DISTINCT TC1_CODCONEX FROM QA_TTC1 WHERE TC1_PERIODO=202305
               ); --VACIA
...
FROM (
        ...
        MINUS
        SELECT DISTINCT TC1_CODCONEX,TC1_IUA FROM QA_TTC1 WHERE TC1_PERIODO=202308
     )
MINUS
(SELECT DISTINCT TC1_CODCONEX FROM QA_TTC1_TEMP
MINUS
...
WHERE TC1_CODCONEX IN (
                        ...
                        FROM(
                        SELECT DISTINCT TC1_CODCONEX AS X,TC1_IUA
                        FROM QA_TTC1 WHERE TC1_PERIODO=202308) T
                        HAVING COUNT(T.X) > 1 
                        GROUP BY T.X
                      );
...
WHERE TC1_PERIODO=202308; --610.877  Filas

DELETE FROM QA_TTC1
WHERE TC1_PERIODO=202308; -- 610,877 rows affected in 1 m 12 s 220 ms
COMMIT;

--INSERTAR QA_TTC1_TEMP A QA_TTC1
INSERT INTO QA_TTC1
SELECT * FROM QA_TTC1_TEMP; --610.874 filas insertadas.

COMMIT;

--Verificacion de la cantidad insertada
SELECT COUNT(*) FROM QA_TTC1 WHERE TC1_PERIODO=202308; --605.353 filas insertadas
--OK
