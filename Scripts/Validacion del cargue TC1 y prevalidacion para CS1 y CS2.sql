...
SELECT DISTINCT TC1_CODCONEX FROM QA_TTC1 WHERE TC1_PERIODO=202212
MINUS
...
FROM (
        ...
        MINUS
        SELECT DISTINCT TC1_CODCONEX,TC1_IUA FROM QA_TTC1 WHERE TC1_PERIODO=202212
     )
MINUS
(SELECT DISTINCT TC1_CODCONEX FROM QA_TTC1_TEMP
MINUS
...
WHERE TC1_CODCONEX IN (
                        ...
                        FROM(
                        SELECT DISTINCT TC1_CODCONEX AS X,TC1_IUA
                        FROM QA_TTC1 WHERE TC1_PERIODO=202210) T
                        HAVING COUNT(T.X) > 1 
                        GROUP BY T.X
                      );
...
WHERE TC1_PERIODO=202212; --598.843  Filas

DELETE FROM QA_TTC1
WHERE TC1_PERIODO=202212; -- 598.843 filas eliminado
COMMIT;

--INSERTAR QA_TTC1_TEMP A QA_TTC1
INSERT INTO QA_TTC1
SELECT * FROM QA_TTC1_TEMP; --598.816 filas insertadas.

COMMIT;

--Verificacion de la cantidad insertada
SELECT COUNT(*) FROM QA_TTC1 WHERE TC1_PERIODO=202212; --598.816 filas insertadas
--OK
