...
SELECT DISTINCT TC1_CODCONEX FROM BRAE.QA_TTC1 WHERE TC1_PERIODO=202301
MINUS
...
MINUS
SELECT DISTINCT TC1_CODCONEX FROM QA_TTC1 WHERE TC1_PERIODO=202301;
...
FROM (
        ...
        MINUS
        SELECT DISTINCT TC1_CODCONEX,TC1_IUA FROM QA_TTC1 WHERE TC1_PERIODO=202301
     )
MINUS
(SELECT DISTINCT TC1_CODCONEX FROM QA_TTC1_TEMP
MINUS
...
WHERE TC1_PERIODO=202301; --596.607  Filas

DELETE FROM QA_TTC1
WHERE TC1_PERIODO=202301; -- 596.607 filas eliminado
COMMIT;

--INSERTAR QA_TTC1_TEMP A QA_TTC1
INSERT INTO QA_TTC1
SELECT * FROM QA_TTC1_TEMP; --599.607 filas insertadas.

COMMIT;

--Verificacion de la cantidad insertada
SELECT COUNT(*) FROM QA_TTC1 WHERE TC1_PERIODO=202301; --598.816 filas insertadas
--OK
