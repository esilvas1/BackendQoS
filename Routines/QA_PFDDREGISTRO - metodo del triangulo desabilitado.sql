...
IF CONTADOR = 0 AND CANTIDAD > 0 THEN --NO PERMITE REPORTE DE INFORMACION SIN QUE SE HAYA REPORTADO EL DIA ANTERIOR
  ...
  --MODIFICAR LOS EVENTOS NR QUE NO TRASLAPAN CON METODOLOGIA 1, PARA QUE SEAN REPORTADOS EN FECHAOPERACION ACTUAL
  ...
  --CONFIGURAR EVENTOS NR QUE TRASLAPAN CON EVENTOS DIARIOS, SOLO SI LAST_DAY(FECHAOPERACION)=FECHAOPERACION
     IF LAST_DAY(FECHAOPERACION) =  FECHAOPERACION THEN
