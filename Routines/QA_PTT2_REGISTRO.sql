 ...
 --VERIFICACION DE ACCION DE AJUSTES REALIZADOS EN LA BASE DE DATOS PARA EL PERIODO 
  ...
  THEN
    ...
    --CREACION DE BACKUP DE LA TABLA QA_TTT2_REGISTRO
      /*DELETE FROM BRAE.QA_TTT2_BACKUP;COMMIT;
      INSERT INTO BRAE.QA_TTT2_BACKUP SELECT * FROM BRAE.QA_TTT2_REGISTO;COMMIT;
      */
  ...
  ELSE
      DBMS_OUTPUT.PUT_LINE('Don´t possible execution of procediment');
