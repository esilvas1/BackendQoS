CREATE OR REPLACE PROCEDURE BRAE.QA_PCS1_AD(FECHAOPERACION DATE)
AS

 TYPE T_CS1 IS TABLE OF QA_TCS1_AD%ROWTYPE;
 V_CS1 T_CS1;
 V_UIXTI_M NUMBER;
 V_UI_M NUMBER;
 V_UT_M NUMBER;
 ...
 --INSERTAR PERIODO OPERACION
    ...
    INSERT INTO QA_TCS1_AD (CS1_PERIODO_OP,CS1_IDMERCADO,CS1_UIXTI_M,CS1_UI_M,CS1_UT_M)
                                                       VALUES(
 ...
 -- ACTUALIZAR INDICADORES SAIDI Y SAIFI DEL AÃ‘O EN CURSO
 ...
 -- ACTUALIZAR INDICADORES SAIDI Y SAIFI DEL AÃ‘O CORRIDO MAT
 SELECT SUM(CS1_SAIDI_M), SUM(CS1_SAIFI_M)
 ...
 -- ACTUALIZAR MAIFI PARA EL MES, ACUMULADO AÃ‘O Y MAT
 -- MAIFI MES
   UPDATE BRAE.QA_TCS1_AD
