...
BEGIN
    ...
    SELECT FECHAOPERACION AS TT12_PERIODO_OP   
        ...
        ,FECHA_INICIAL	AS	TT12_FINICIAL
        ,FECHA_FINAL	AS	TT12_FFINAL
    ...
    --INSERTAR LOS REGISTROS DE EVENTOS PROGRAMADOS Y EJECUTADOS          
        ...
        FROM    (
                ...
                LEFT OUTER JOIN (SELECT DISTINCT TT12_CODIGOEVENTO,TT12_ID FROM QA_TTT12_TEMP) T2 ON T2.TT12_CODIGOEVENTO = R.FDD_CODIGOEVENTO
