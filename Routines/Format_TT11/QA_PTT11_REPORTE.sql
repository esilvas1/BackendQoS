CREATE OR REPLACE PROCEDURE QA_PTT11_REPORTE(FECHAOPERACION DATE) AS
        ...
        FROM(        
            ...
            (
                ...
                LEFT OUTER JOIN (
                                 ...
                                 FROM   QA_TTC1
                                 WHERE  TO_DATE('01/'||SUBSTR(TC1_PERIODO,5,6)||'/'||SUBSTR(TC1_PERIODO,1,4),'DD/MM/YYYY') = ADD_MONTHS(FECHAOPERACION,-2)
                                 AND    TC1_TIPCONEX = 'T'
                                 GROUP BY TC1_CODCIRC    
                                 ) T2 ON T2.TC1_CODCIRC =  T1.TC1_CODCIRC
                WHERE  TO_DATE('01/'||SUBSTR(T1.TC1_PERIODO,5,6)||'/'||SUBSTR(T1.TC1_PERIODO,1,4),'DD/MM/YYYY') = ADD_MONTHS(FECHAOPERACION,-2)
